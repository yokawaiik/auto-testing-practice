...
public class BaseTest {
  ...
  public void initDriver() throws Throwable {
    ...
    driver
      ...
      .timeouts()
      .implicitlyWait(
        Duration.ofMillis(TestConstants.IMPLICITLY_WAIT_IN_MILLISECONDS)
      );
    driver
      .get()
      .manage()
      .timeouts()
      .pageLoadTimeout(
        Duration.ofSeconds(TestConstants.PAGE_LOAD_TIMEOUT_IN_SECONDS)
      );
  }
